...
FULLSAMPLE_K_RESOLUTION_PC = expand("full_sample_preprocess/full_sample_k_{k}_resolution_{resolution}_PC_{pc}.h5ad", \
...
rule full_sample_preprocess:
	input: INPUT_SEURAT
	output: "full_sample_preprocess/full_sample_k_{k}_resolution_{resolution}_PC_{pc}.h5ad"
...
rule subsample_cluster:
	input: "full_sample_preprocess/full_sample_k_{k}_resolution_{resolution}_PC_{pc}.h5ad"
